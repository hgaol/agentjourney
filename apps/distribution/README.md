...
MP4 export uses a compatible local browser and FFmpeg when available. Missing video dependencies do not prevent archive and review features from starting.
